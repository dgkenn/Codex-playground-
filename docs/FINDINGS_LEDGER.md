...
| S-v2 | **Target-trial emulation (g-methods, time-varying) on shock-reversal + phenotype×steroid HTE** | running | — | **in progress — does time-varying adjustment move the naive harmful estimate; does C2 modification survive** |
