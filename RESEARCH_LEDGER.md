...
- **Refuted (actively disproven):** Maker (post-lock weather), maker (favorite-longshot resting-bid, all liquid categories), near-miss conversion, illiquid snapshot arbs, weather calibration-fade, long-tail passive spread, stacked r1s1
