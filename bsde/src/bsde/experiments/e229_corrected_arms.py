#!/usr/bin/env python3
"""E229 -- E227 re-run on the arms E227 was supposed to have had.
...
exposures E224 used, so the two files are directly comparable.
    ...
    python bsde/src/bsde/experiments/e229_corrected_arms.py
"""
...
OUT = "bsde/results/e229_corrected_arms.json"
...
def main() -> int:
    ...
    print("arms:", {k: len(v) for k, v in arms.items()},
          f"| {misclassified} cases carry a volatile track that is zero throughout and were "
          "treated as volatile cases by E224/E225/E227")
