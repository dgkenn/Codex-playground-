...
- Feature cases extracted: **2** (23 arterial, 9 ECG-coupling features).
- Requirement-phenotype cases: **52**; merged: **1**.

## Verdict
INSUFFICIENT merged N=1 (feature cases 2, phenotype 52).
